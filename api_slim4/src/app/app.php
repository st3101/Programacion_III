...
/*
    ...
    $consulta = $objetoAccesoDato->retornarConsulta("INSERT INTO usuarios (nombre, apellido, correo, foto, id_perfil, clave) VALUES ('Santiago', 'Leonardi', 'Santiago.t.leonardi@gmail.com', '/aa/bb/cc', 1, 'laMasSegura')");
    if($consulta->execute() == true){
        $retorno = "Usuario cargado";
    }
    else{
        $retorno = "Usuario no cargado";
    }
