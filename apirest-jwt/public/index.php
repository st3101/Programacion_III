...
// POO
//************************************************************************************************************//
require_once __DIR__ . "/../src/poo/JWT.php";
require_once __DIR__ . "/../src/poo/usuario.php";

$app->post('/jwt/poo/crear[/]', \JWT::class . ':crear');

$app->post('/jwt/poo/verificar[/]', \JWT::class . ':verificar');

$app->post('/jwt/poo/obtener_payload[/]', \JWT::class . ':obtenerPayLoad');

$app->post('/jwt/poo/obtener_datos[/]', \JWT::class . ':obtenerDatos');

$app->get('/jwt/poo/verificar[/]',\JWT::class . ':verificarPorHeader');

$app->get('/listado/autos[/]', \JWT::class . ':obtenerAutosJson');

$app->get('/listado/autos/jwt[/]', \JWT::class . ':obtenerAutosJson')->add(\JWT::class . ':verificarToken');
