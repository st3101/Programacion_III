...
class Usuario implements ISlimeable
{
    ...
    public function login(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            $jsonDesencodiado = json_decode($arrayDatos["obj_json"]);
            $usuario = Usuario::buscarUsuarioLogin($jsonDesencodiado->correo);

            if ($usuario->VerficarUsuario($jsonDesencodiado->clave)) {
                $info = array(
                    'status' => 'success',
    ...
    public function VerficarUsuario($clave)
    {
        $retorno = false;
        if ($clave != null) {
            if ($this->clave == $clave) {
